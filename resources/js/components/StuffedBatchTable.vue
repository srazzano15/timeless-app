...
<!--     <div class="row base__table--full">
        ...
        <table class="highlight reports__table">
            <thead>
                <tr>
                    <th @click="sortCol('submitter')">Submitted By</th>
                    <th @click="sortCol('batch_id')">Batch ID</th>
                    <th @click="sortCol('cooler')">Cooler</th>
                    <th @click="sortCol('total_batch_weight')">Total Flower Weight</th>
                    <th @click="sortCol('bag_weight')">Total Pillow Weight</th>
            ...
            <tbody>
                <tr v-for="(result, index) in sortedResults" :key="index">
                    ...
                    <td>{{ result.cooler }}</td>
                    <td>{{ result.total_batch_weight }}</td>
                    <td>{{ result.total_flower_weight }}</td>
                    <td>{{ result.created_at }}</td>
                    <td><a :href="routeFormat(result.id)" type="button" class="btn btn--p bgc--yellow">Run Batch</a></td>
                </tr>
            </tbody>
        </table>
